...
<html>
    ...
    <body>
        ...
        <div id='cssmenu' style="position: fixed; top: 0; width: 100%;z-index: 99">
            <ul>
                <li class='active'> <a  href="main.jsp" class="icon-home ">Main</a></li>
            ...
            <div class="container-table100">
                <div class="wrap-table100">
                    <div class="table100 ver5 ">
                        <table id="myTable" style="table-layout: fixed; width: 100%;">
                            ...
                            <tbody>
                                <c:forEach var="country" items="${hs}">
                                    <c:if test = "${!fn:contains(country.key, 'PUBLIC_KEY') && !fn:contains(country.key, 'AMAZONE_PURCHASES_KEY')}">
                                    ...
                                    <form id="form${country.key}" action="SendAndReadAPI" method="GET" class="w3-container" onsubmit="myFunction('${country.key}')">
                                        <tr class="row100 border border-bottom-0">
                                            <td class="column100 column1 border border-bottom-0"  data-column="">  <c:out value="${country.key}"/>  </td>
                        ...
                        <br/>
                        <h5>© Công ty Cổ phần công nghệ GVN</h5>
                    </div> 
                </div>
            </div>
        </div>
