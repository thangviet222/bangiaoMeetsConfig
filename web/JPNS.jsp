    ...
    <body>
        ...
        <div id='cssmenu' style="position: fixed; top: 0; width: 100%;z-index: 99">
            <ul>
                ...
                <li class='active'> <a href="JPNS.jsp" class="icon-star">JPNS</a></li>
                <li> <a href="meet.jsp" class="icon-mail">Meet People</a></li>
        ...
        <div class="limiter">
            ...
            <form action="Backup">
                ...
                <input id="tokenbackup" type="hidden" name="token" value="JPNS">
            </form>
                        ...
                        <table id="myTable" style="table-layout: fixed; width: 100%">
                            ...
                            <tbody>
                                <c:forEach var="country" items="${hs}">
                                    ...
                                    <form id="form${country.key}" action="SendAndReadAPI" method="GET" class="w3-container" onsubmit="myFunction('${country.key}')">
                                        <tr class="row100 border border-bottom-0">
                                            ...
                                            <td id="${country.key}" contenteditable="true"  style="word-wrap: break-word; ${valueParts[1] == 'false' ? 'background-color: #47c9af; color: #FFFFFF':''}" class="column100 column2" data-column="column2" key="${country.key}" valueofkey="${valueParts[0]}"  onkeyup="myFunctionKeypress(this)"> 
                                                <c:choose>
                                                    <c:when test="${country.key == 'production'}">

                                                        <select id="productionSelect" class="selectpicker" style=" width: 20%" onchange="changeSelectProduct('${country.key}', this, '${valueParts[0]}')">
                                                            <option value="true">true</option>
                                                            <option value="false">false</option>
                                                        </select>
                                                        <script>
                                                            document.getElementById("productionSelect").value = "${valueParts[0]}";
                                                        </script>
                                                    </c:when>
                                                    <c:otherwise>
        ...
        <script type="text/javascript">
                                                    ...
                                                    document.getElementById("production").setAttribute("contenteditable", "false");
        </script>
        <script type="text/javascript">
            (function ($) {
                function processForm(e) {
